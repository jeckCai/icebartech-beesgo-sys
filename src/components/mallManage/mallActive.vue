 ...
 * @LastEditTime: 2019-12-10 17:18:55
 --> 
<template>
  <div class="xb"> 
    <div class="input_modal">
      <div class="input-item">
         <el-button type="primary" style="margin-left:20px"  @click="handleShowModal('mall',0)">新增活动</el-button>
      </div>  
    </div>
    <div class="input_modal">
      <div class="input-item">
      ...
      <el-table :data="tableData">
        ...
        <el-table-column prop label="操作" width="380px">
          <template slot-scope="scope">
            ...
            <el-button type="primary" size="mini" @click="handleShowModal('shop',1,scope.row.id)">查看</el-button>
            <!-- <el-button type="primary"  v-if="scope.row.auditStatusDesc!=='审核通过'||scope.row.isSale=='n'" size="mini" @click="handleShowModal('sys',2,scope.row.id)">编辑</el-button>
            <el-button type="danger" v-if="scope.row.auditStatusDesc!=='审核通过'||scope.row.isSale=='n'" size="mini" @click="handleDeleteItem(scope.row.id)">删除</el-button> -->
            <!-- <el-button type="info" v-if="scope.row.isSale=='y'" size="mini" >删除</el-button> -->
            ...
            <!-- <el-button  v-else type="primary" size="mini" @click="handleShowModal('sys',3,scope.row.id)">审核</el-button> -->
          </template>
        </el-table-column>
      </el-table>
    </div> 
...
export default {
  ...
  methods: {
    ...
    //获取列表
      ...
      httpPost('SHOPACTIVELIST',param).then(res=>{
        if (res.code == 200) {
