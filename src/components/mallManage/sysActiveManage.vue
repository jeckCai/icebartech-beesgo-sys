 ...
 * @LastEditTime : 2019-12-18 14:15:48
 --> 
<template>
  <div class="xb"> 
      ...
      <el-table :data="tableData">
        ...
        <el-table-column prop label="操作" width="380px">
          <template slot-scope="scope">
            ...
            <el-button type="primary" size="mini" @click="handleShowModal('mall',1,scope.row.id)">查看</el-button>
            <el-button type="primary"  v-if="scope.row.auditStatusDesc!=='审核通过'||scope.row.isSale=='n'" size="mini" @click="handleShowModal('mall',2,scope.row.id)">编辑</el-button>
            ...
            <el-button  v-else type="primary" size="mini" @click="handleShowModal('mall',3,scope.row.id)">审核</el-button>
          </template>
        </el-table-column>
      </el-table>
    </div> 
