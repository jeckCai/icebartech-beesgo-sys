 ...
 * @LastEditTime : 2019-12-25 19:28:52
 --> 
<template>
  <div class="xb"> 
    <!-- <div class="input_modal">
      <div class="input-item">
         <el-button type="primary" style="margin-left:20px"  @click="handleShowModal('brand',0)">新增活动</el-button>
      </div>  
    </div> -->
    <div class="input_modal">
      <div class="input-item">
      ...
      <el-table :data="tableData">
        ...
        <el-table-column prop label="操作" width="380px">
          <template slot-scope="scope">
            ...
            <el-button type="primary" size="mini" @click="handleShowModal('brand',1,scope.row.id)">查看</el-button>
            <el-button type="primary"  v-if="scope.row.auditStatusDesc!=='审核通过'||scope.row.isSale=='n'" size="mini" @click="handleShowModal('brand',2,scope.row.id)">编辑</el-button>
            ...
            <el-button  v-else type="primary" size="mini" @click="handleShowModal('brand',3,scope.row.id)">审核</el-button>
          </template>
        </el-table-column>
      </el-table>
    </div> 
