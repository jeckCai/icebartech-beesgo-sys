 ...
 * @LastEditTime : 2019-12-23 18:12:14
        ...
        <!-- 头部 -->
          ...
          <div class="form">
               ...
               <div class="flex">
                ...
                <div class="flex">
                    <div class="_title" style="height:80px;">商品sku图: </div>
                    <img style="width:100px;margin-right:10px;" v-for="(item,index) in form.goodImageInfo.imageStyles" :key="index" :src="item.imageUrl" alt="">
               </div>
                 <!-- 商品属性 -->
                <div class="flex" v-for="(item,index) in form.attributeDTOS" :key="index">
                 ...
                 <div class="flex">
                    ...
                    <span >{{form.frightPrice}}元</span>
               </div>
                <!-- <div class="flex">
                    <span class="_title">优惠券:</span>
                    <span v-html="form.totalPrice"></span>
               </div> -->
                 <div class="flex">
                    <span class="_title">实付款:</span>
                    <span v-html="form.actualPrice"></span>
               </div>
